...
export const blogArticles: BlogArticle[] = [
  {
    ...
    content: `
      ...
      <h3>Conclusion</h3>
      <p>L'optimisation GMB est un processus continu qui demande de la régularité et de la stratégie. En suivant ces conseils, vous maximiserez votre visibilité locale et attirerez plus de clients qualifiés.</p>
    `,
    author: "Sabri SEO",
    date: "2024-01-15",
    readTime: "8 min",
  ...
  },
  {
    ...
    content: `
      ...
      <p>1. Vérifiez la cohérence de vos informations<br>
      2. Optimisez vos photos<br>
      3. Répondez aux avis en attente<br>
      4. Planifiez vos publications<br>
      5. Activez tous les attributs pertinents</p>
    `,
    author: "Sabri SEO",
    date: "2024-01-10",
    readTime: "6 min",
